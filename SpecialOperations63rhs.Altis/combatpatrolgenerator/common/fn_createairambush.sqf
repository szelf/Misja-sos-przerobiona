...
// Create helicopter
_chopper = createVehicle ["RHS_Mi8AMT_vdv", [_x, _y], [], 0, "FLY"];
...
_pilot = _group_0 createUnit ["rhs_vdv_crew_commander", [0, 0, 0], [], 0, "CAN_COLLIDE"];
...
_ai1 = _group_1 createUnit ["rhs_vdv_flora_rifleman", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai1 moveInCargo _chopper;

_ai2 = _group_1 createUnit ["rhs_vdv_flora_machinegunner", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai2 moveInCargo _chopper;

_ai3 = _group_1 createUnit ["rhs_vdv_flora_rifleman", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai3 moveInCargo _chopper;

_ai4 = _group_1 createUnit ["rhs_vdv_flora_grenadier", [10, 10, 0], [], 0, "CAN_COLLIDE"];
...
_ai5 = _group_2 createUnit ["rhs_vdv_flora_rifleman", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai5 moveInCargo _chopper;

_ai6 = _group_2 createUnit ["rhs_vdv_flora_machinegunner", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai6 moveInCargo _chopper;

_ai7 = _group_2 createUnit ["rhs_vdv_flora_grenadier", [10, 10, 0], [], 0, "CAN_COLLIDE"];
_ai7 moveInCargo _chopper;

_ai8 = _group_2 createUnit ["rhs_vdv_flora_rifleman", [10, 10, 0], [], 0, "CAN_COLLIDE"];
