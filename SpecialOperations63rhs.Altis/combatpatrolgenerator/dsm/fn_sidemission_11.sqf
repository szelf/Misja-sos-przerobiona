...
if (_counter < 10000) then {
	...
	_at1 = _grp createUnit ["rhs_vdv_at", _missionPos, [], 0, "NONE"];
	_at2 = _grp createUnit ["rhs_vdv_at", _missionPos, [], 0, "NONE"];
	_at3 = _grp createUnit ["rhs_vdv_strelok_rpg_assist", _missionPos, [], 0, "NONE"];
