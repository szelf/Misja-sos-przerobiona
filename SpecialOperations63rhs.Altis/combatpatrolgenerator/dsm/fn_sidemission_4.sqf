...
private["_buildingPos", "_grpPos", "_mrkPos", "_cachePos", "_targets", "_target", "_posarray", "_mrkPatrol", "_mrk", "_ammo1", "_ammo2", "_ammo3", "_ammo4", "_ammo5"];
...
if ((count _targets) > 0) then {
	...
	for "_i" from 0 to 10 do {
		_bomb = createVehicle ['R_60mm_HE', _grpPos, [], 0, 'NONE'];
