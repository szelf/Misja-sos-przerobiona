...
private["_missionPos", "_grpPos", "_overwatchPos", "_mrkPos", "_barrier1", "_barrier2", "_barrier3", "_barrier4" ,"_barrel1" , "_mrkPatrol", "_mrk", "_counter", "_chopper", "_chopperType"];
...
if (_counter < 10000) then {
	...
	if ((random 100) < 50) then	{
		_chopper		= createVehicle ["RHS_Mi8MTV3_FAB_vdv", _missionPos, [], 0, "NONE"];
		_chopperType	= "Mi8";
	} else {
		_chopper		= createVehicle ["RHS_Mi24V_AT_vdv", _missionPos, [], 0, "NONE"];
		_chopperType	= "Mi24";
	};
	...
	_ai = _chopperGroup createUnit ["rhs_vdv_combatcrew", _missionPos, [], 0, "NONE"];
